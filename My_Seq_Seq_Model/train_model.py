...
from utils import read_vocab,write_vocab,build_vocab,Tokenizer,timeSince
...
import pandas as pd
# import filesss missing for NOW!
...
def setup():
    ## Hey! Check for heineous errors these following two commands can produce! Watch your way out!
    ## I recommend you to take the precautions!
    torch.manual_seed(1)
...
## Should I put something like if ==  main at the end, then run this thing etc...?
def train_val():
...
def train(train_env, encoder, decoder, n_iters, log_every=100, val_envs={}):
    ...
    for idx in range(0, n_iters, log_every):
        ...
        for env_name, (env, evaluator) in val_envs.items():
            ...
            ## BTW, couldn't really understand much about this validation distance thing and the 
            ## validation loss thing! Like what's really the difference b/w them and also b/w these
